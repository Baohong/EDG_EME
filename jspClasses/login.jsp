<%@page import="java.util.Enumeration,javax.xml.parsers.DocumentBuilderFactory,javax.xml.parsers.DocumentBuilder,org.w3c.dom.Document,org.w3c.dom.NodeList,org.w3c.dom.Node,java.io.File"%><%!
    public class login {
        ...
        public login(ServletContext servletContext) {
            ...
            this.hardWiredFilePath = getServletContext().getInitParameter("EmeFilesPath");
            this.out = out;
        }
...
/*
         * This function returns the user id from the header info
         * @param  : request   HttpServletRequest  Request object
         * @return : String     uid of the current user   
         */
